...
export default function StudentNotificationsPage() {
  ...
  const notifications = [
    { id: 1, type: 'warning', title: 'واجب مستحق', message: 'لديك واجب رياضيات مستحق اليوم', time: 'منذ ساعة', unread: true },
    { id: 2, type: 'success', title: 'درس جديد', message: 'تم إضافة درس جديد في دورة الفيزياء', time: 'منذ ساعتين', unread: true },
    { id: 3, type: 'info', title: 'رد من الأستاذ', message: 'رد الأستاذ أحمد على سؤالك', time: 'منذ 3 ساعات', unread: false },
  ]
