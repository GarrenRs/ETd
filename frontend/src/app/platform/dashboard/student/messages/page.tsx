...
export default function StudentMessagesPage() {
  ...
  const conversations = [
    { id: 1, name: 'د. أحمد محمد', role: 'أستاذ - رياضيات', lastMessage: 'سأشرح لك الدرس غداً', time: 'منذ 10 دقائق', unread: 1 },
    { id: 2, name: 'د. سارة علي', role: 'أستاذة - فيزياء', lastMessage: 'ممتاز، استمر', time: 'منذ ساعة', unread: 0 },
  ]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">تواصل مع الأساتذة</p>
            </div>
          </div>
        </div>
      </header>
