...
export default function TeacherMessagesPage() {
  ...
  const conversations = [
    { id: 1, name: 'أحمد محمد', role: 'طالب', lastMessage: 'شكراً على التوضيح', time: 'منذ 5 دقائق', unread: 1 },
    { id: 2, name: 'سارة علي', role: 'طالبة', lastMessage: 'متى موعد الاختبار؟', time: 'منذ 30 دقيقة', unread: 0 },
  ]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">تواصل مع الطلاب</p>
            </div>
          </div>
        </div>
      </header>
