...
export default function SupervisorNotificationsPage() {
  ...
  const notifications = [
    { id: 1, type: 'warning', title: 'محتوى جديد للمراجعة', message: 'تم رفع درس جديد ينتظر المراجعة', time: 'منذ 5 دقائق', unread: true },
    { id: 2, type: 'info', title: 'شكوى جديدة', message: 'تم تقديم شكوى من طالب', time: 'منذ 30 دقيقة', unread: true },
    { id: 3, type: 'success', title: 'تمت الموافقة', message: 'تمت الموافقة على المحتوى المراجع', time: 'منذ ساعة', unread: false },
  ]
